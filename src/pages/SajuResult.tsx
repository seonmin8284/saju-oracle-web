...
import { getSajuFromSessionStorage, getSajuResult } from '../services/sajuService';
...
const SajuResult = () => {
  ...
  const handleDownloadReport = () => {
    ...
    toast({
      title: '운세 리포트',
      description: '운세 리포트 다운로드는 유료 서비스입니다.',
    });
  };
    ...
    return (
      <Layout>
        <div className="flex flex-col justify-center items-center min-h-[50vh]">
          <div className="text-xl text-indigo mb-4">사주 데이터를 찾을 수 없습니다.</div>
      ...
      <div className="max-w-4xl mx-auto">
                ...
                <div className="animate-fade-in">
                  <div className="grid md:grid-cols-2 gap-6 mb-6">
                    <div className="bg-lavender/20 p-4 rounded-lg">
                      ...
                      <p className="text-xl font-semibold">{sajuResult.ohaeng}</p>
                    ...
                    <div className="bg-lavender/20 p-4 rounded-lg">
                      ...
                      <p className="text-xl font-semibold">{sajuResult.sipsin}</p>
                      <p className="text-gray-600 mt-2">
                  ...
                  <p className="text-gray-700 mb-6 leading-relaxed">
                    귀하의 사주는 {sajuResult.ohaeng} 오행과 {sajuResult.sipsin} 십신을 중심으로 구성되어 있습니다. 
        ...
        {!user && (
          <div className="bg-lavender/20 p-4 rounded-lg text-center mb-8">
            <p className="text-gray-700 mb-3">로그인하시면 사주 결과를 저장하고 추가 기능을 이용할 수 있습니다.</p>
