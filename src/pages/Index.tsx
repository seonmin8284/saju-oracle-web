...
const Index = () => {
  ...
  const handleAnimalClick = (animalId: number) => {
    navigate(`/fortune?animal=${animalId}`);
  };
      ...
      <section className="mt-4 mb-12 text-center">
        ...
        <div className="my-16">
          ...
          <div className="mt-8">
            <Link
              to="/fortune"
              className="text-indigo hover:text-deep-indigo font-medium flex items-center justify-center gap-2 transition-colors"
            >
        ...
        <div className="my-16">
          <h2 className="text-2xl font-bold mb-6 text-indigo">
            나만의 사주 해석
          </h2>
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="saju-card">
              <div className="text-3xl mb-2">📊</div>
              <h3 className="text-xl font-semibold mb-2 text-indigo">
                기본 해석
              </h3>
              <p className="text-gray-600 mb-4">
                생년월일과 태어난 시간을 바탕으로 기본적인 사주 해석을 무료로
                제공합니다.
              </p>
              <Link
                to="/saju-input"
                className="text-indigo hover:text-deep-indigo font-medium inline-flex items-center gap-1 transition-colors"
              >
            ...
            <div className="saju-card">
              ...
              <p className="text-gray-600 mb-4">
                진로, 연애, 재물운 등 다양한 영역에 대한 심층 분석 리포트를
                제공합니다.
              </p>
            ...
            <div className="saju-card">
              ...
              <p className="text-gray-600 mb-4">
                당신의 사주를 이해하는 AI와 실시간으로 대화하며 궁금한 점을
                질문해보세요.
              </p>
              <span className="text-indigo font-medium inline-flex items-center gap-1 opacity-50 cursor-not-allowed">
                곧 출시됩니다
        ...
        <div className="my-16 bg-lavender/20 py-16 rounded-2xl">
          <h2 className="text-2xl font-bold mb-6 text-indigo">
            만세력 소셜 미디어
          </h2>
          <p className="text-gray-600 mb-12">
            인스타그램과 유튜브에서 더 많은 만세력 콘텐츠를 만나보세요
          </p>
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto px-4">
            <a
              href="https://instagram.com/manseryeok"
              target="_blank"
            ...
            >
              ...
              <span className="text-pink-500 font-medium inline-flex items-center gap-2">
                인스타그램 바로가기 <ArrowRight size={16} />
              </span>
            </a>

            <a
              href="https://youtube.com/@manseryeok"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300"
            >
              ...
              <span className="text-red-500 font-medium inline-flex items-center gap-2">
                유튜브 채널 바로가기 <ArrowRight size={16} />
              </span>
            </a>
          </div>
        </div>
